...
//        }
    ...
    private void initComponents() {
        ...
        btnSPNB = new javax.swing.JButton();
        ...
        btnSPNB.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/eye1.png"))); // NOI18N
        btnSPNB.setText("Sản phẩm ngừng bán");
        btnSPNB.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnSPNBActionPerformed(evt);
            }
        });
    ...
    private void btnSPNBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSPNBActionPerformed
        // TODO add your handling code here:
        JFrame loginFrame = new JFrame();
        JDialog dia = new SanPhamNgungBanJDialog(loginFrame, true);
        dia.setVisible(true);
    }//GEN-LAST:event_btnSPNBActionPerformed

    private void txtTimKiemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtTimKiemActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtTimKiemActionPerformed

    private boolean validateSanPhamForm() {
    ...
    // Kiểm tra giá sản phẩm: không được trống và phải là số dương
    String giaText = txtGia.getText().trim();
    if (giaText.isEmpty()) {
        MsgBox.alert(this, "Giá sản phẩm không được để trống!");
        return false;
    }
    try {
        ...
        MsgBox.alert(this, "Giá sản phẩm phải là số hợp lệ!");
        return false;
    }
    // Kiểm tra số lượng: không được trống và phải là số nguyên không âm
    String soLuongText = txtSoLuong.getText().trim();
    if (soLuongText.isEmpty()) {
        MsgBox.alert(this, "Số lượng sản phẩm không được để trống!");
        return false;
    }
    try {
        int soLuong = Integer.parseInt(soLuongText);
        if (soLuong < 0) {
            MsgBox.alert(this, "Số lượng sản phẩm phải là số nguyên không âm!");
            return false;
        }
    } catch (NumberFormatException e) {
        MsgBox.alert(this, "Số lượng sản phẩm phải là số nguyên hợp lệ!");
        return false;
    }
    // Kiểm tra combobox: Size
    if (cbbSize.getSelectedItem() == null || cbbSize.getSelectedItem().toString().trim().isEmpty()) {
        MsgBox.alert(this, "Vui lòng chọn Size!");
        return false;
    }
    // Kiểm tra combobox: Màu sắc
    if (cbbMauSac.getSelectedItem() == null || cbbMauSac.getSelectedItem().toString().trim().isEmpty()) {
        MsgBox.alert(this, "Vui lòng chọn Màu sắc!");
        return false;
    }
    // Kiểm tra combobox: Chất liệu
    if (cbbChatLieu.getSelectedItem() == null || cbbChatLieu.getSelectedItem().toString().trim().isEmpty()) {
        MsgBox.alert(this, "Vui lòng chọn Chất liệu!");
        return false;
    }
    // Kiểm tra combobox: Danh mục
    if (cbbDanhMuc.getSelectedItem() == null || cbbDanhMuc.getSelectedItem().toString().trim().isEmpty()) {
        MsgBox.alert(this, "Vui lòng chọn Danh mục!");
        return false;
    }
    // Kiểm tra combobox: Thương hiệu
    if (cbbThuongHieu.getSelectedItem() == null || cbbThuongHieu.getSelectedItem().toString().trim().isEmpty()) {
        MsgBox.alert(this, "Vui lòng chọn Thương hiệu!");
        return false;
    }
    // Kiểm tra combobox: Trạng thái sản phẩm
    if (cbbTrangThai.getSelectedItem() == null || cbbTrangThai.getSelectedItem().toString().trim().isEmpty()) {
        MsgBox.alert(this, "Vui lòng chọn trạng thái sản phẩm!");
        return false;
    }
    return true;
}
    ...
    private javax.swing.JButton btnSPNB;
