...
public class Form_NhanVien extends javax.swing.JPanel {
    ...
    private void cboTrangThaiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cboTrangThaiActionPerformed
        // TODO add your handling code here:
        DefaultTableModel searchDefaultTableModel = (DefaultTableModel) tbNhanVien.getModel();
        ...
        try {
            List<NhanVien> list;
            if (tt == null) {
                list = nhanVienService.selectAll();
            } else {
                cboChucVu.setSelectedIndex(0);
                list = nhanVienService.searchDataTrangThai(tt);
            }
            if (list.isEmpty()) {
    ...
    private void txtTimKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtTimKeyReleased
        ...
        try {
            List<NhanVien> list = nhanVienService.searchDataMa(ma); 
            showData(list); 
        } catch (Exception e) {
            e.printStackTrace(); 
        }
