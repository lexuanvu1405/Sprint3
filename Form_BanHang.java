...
//        this.loadTienThanhToan();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (frame != null) {
            KhachHangJDialog khachHangDialog = new KhachHangJDialog(frame, true, this.lblTenKH, this.txtSDT);
    ...
    // Kiểm tra số lượng hóa đơn hiện có, nếu lớn hơn hoặc bằng 10 thì không cho tạo mới
    if (hdService.getBillCount() >= 10) {
        MsgBox.alert(this, "Số lượng hóa đơn đã đạt giới hạn (10 hóa đơn). Không thể tạo hóa đơn mới!");
        return;
    }
    ...
    private void updateBill() {
        ...
        String sdt = txtSDT.getText();
        KhachHang kh = khService.selectBySDT(this.txtSDT.getText());
        hd.setIdKH(kh.getId());
        hd.setKh(kh);
        hd.setId(hoaDon.getId());
