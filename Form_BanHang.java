...
//        double tienThua = tienKhachTraDouble - tongTienDouble;
...
//        }
    ...
    if (frame != null) {
        ...
        // Khi hộp thoại đóng, lấy khách hàng đã chọn
        KhachHang khachHang = khachHangDialog.getSelectedCustomer();
        if (khachHang != null) { // Nếu đã chọn khách hàng thì hiển thị
            System.out.println("Dữ liệu nhận: " + khachHang.getTen() + " - " + khachHang.getSdt()); // Debug
            lblTenKH.setText(khachHang.getTen());  
            System.out.println("tên sau khi set: " + lblTenKH.getText());
            txtSDT.setText(khachHang.getSdt());
            System.out.println("txtSDT sau khi set: " + txtSDT.getText());
        } else {
            System.out.println("Không có khách hàng nào được chọn.");
        }
    }
